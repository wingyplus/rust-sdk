...
- **What the macros expand into lives in `dagger::__internal`, and moving a name
  ...
  `EnumType`) is reachable only through the `#[doc(hidden)] pub mod __internal`,
  ...
  Renaming anything under `__internal` means editing the emitter in
