...
pub use module::{
    ...
    encode_int_list, encode_module_object, encode_null, encode_object, encode_object_list,
    encode_string, encode_string_list, encode_void, error_message, from_ids, serve, ArgDef,
    Arguments, EnumDef, EnumMemberDef, EnumType, FunctionDef, Object, SourceMapDef,
};
